...
<section id="container" class="">
    ...
    <header class="header white-bg">
        <div class="sidebar-toggle-box">
            <div data-original-title="Toggle Navigation" data-placement="left" class="icon-reorder tooltips"></div>
        </div>
        <!--logo start-->
        ...
        <div id="sidebar"  class="nav-collapse ">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    <a href="javascript:;" class="">
                        <i class="icon-cogs"></i>
                        <span>سالن های برگزاری</span>
                        <span class="arrow"></span>
                    </a>
                    <ul class="sub">
                        <li><a class="" href="<?= url('admin/salon') ?>">مشاهده سالن ها</a></li>
