...
@section('content')
    ...
    <h2  style="text-align:center;margin-bottom: 50px;font-size: 45px;">مشاهده اسلایدر </h2>

    <div class="container">

        <!-- Normal Demo-->
        @foreach($slider->all() as $sldr)
            ...
            <div class="column">
                ...
                <div class="post-module">
                    ...
                    <div class="thumbnai">
                        ...
                        <img  src="<?= url('images/'.$sldr->image) ?> "/>

                    </div>
                    <!-- Post Content-->
                    <div class="post-content">
                        <div class="category">{{$sldr->content}}</div>
                        <h1 class="title">{{ $sldr->text}}</h1>
                        ...
                        <div class="row"  style="text-align: center">
                            <div class="btn-group " style="border-radius: 0; ">
                                <a href="<?= url('/slider/'.$sldr->id.'/edit') ?>" type="button" class="btn btn-warning">ویرایش</a>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title"> حذف سیمنار {{$sldr->title}}</h4>
                                </div>
                                <div class="modal-body">
                                    <p>برای انتقال به زباله دان سیمنار  {{$sldr->title}}  بر روی حذف کلیک کنید</p>
                                </div>
